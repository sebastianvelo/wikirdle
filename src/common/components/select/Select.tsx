...
const Select: React.FC<SelectProps> = ({ label = "", name, value = "", options, className = "", onChange }) => {
    ...
    const listClassName = "flex flex-col absolute z-50 w-full bg-white/80 dark:bg-secondary-900/80 backdrop-blur-2xl border border-accent-500/50 dark:border-accent-500/50 rounded-md shadow-lg overflow-y-auto scrollbar transition-all duration-300";
