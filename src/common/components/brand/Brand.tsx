...
const Brand: React.FC = () => {
    ...
    const tight = `${className} group-hover:tracking-tight transition-all duration-200 ease-in group-hover:text-primary-800/40 dark:group-hover:text-primary-500/40`;

    return (
        <a href={ScreenPath.home} className="group cursor-pointer text-4xl font-bold font-lakki-reddy pt-4">
