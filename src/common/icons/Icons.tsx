import { Globe, Home, Moon, Share2, Sun } from "lucide-react";
...
const Icons = {
    ...
    Search: () => (
        <svg className="w-6 h-6 text-primary-800 dark:text-primary-300/60 absolute right-3 top-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    LineDivider: () => (
        <div className="flex items-center w-full py-2 my-4">
            ...
            <div className="flex-shrink-0 mx-4 w-4 h-4 bg-primary-800/80 dark:dark:bg-primary-300/80 rounded-full"></div>
            <div className="flex-grow border-t border-tertiary-400/50 dark:border-tertiary-700/50"></div>
        </div>
    )
};
