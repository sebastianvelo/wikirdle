...
const Icons = {
    ...
    Search: () => (
        <svg className="w-6 h-6 text-primary-950 dark:text-primary-300 absolute right-3 top-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
