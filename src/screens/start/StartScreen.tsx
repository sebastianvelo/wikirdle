          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="h-8 w-8 rounded-full bg-primary-500 flex items-center justify-center text-white mr-3 flex-shrink-0">1</div>
              ...
              <div className="flex items-start">
                <div className="h-8 w-8 rounded-full bg-primary-500 flex items-center justify-center text-white mr-3 flex-shrink-0">2</div>
                <p className="text-sm lg:text-lg">Debes hacerlo navegando por los <span className="text-primary-300 font-bold underline">links</span> que aparecen en los artículos.</p>
              </div>
              <div className="flex items-start">
                <div className="h-8 w-8 rounded-full bg-primary-500 flex items-center justify-center text-white mr-3 flex-shrink-0">3</div>
