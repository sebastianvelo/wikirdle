...
const GameInstructions: React.FC = () => {
  ...
  return (
    <GlassCard className="isolate hover:bg-white/60 dark:hover:bg-black/60 p-6">
      <details>
        <summary className="list-none cursor-pointer focus:outline-none">
          <h2 className="text-2xl font-bold text-primary-900 dark:text-secondary-200 mb-6 flex items-center">
